...
-- Customers table: unified identity across channels
...
-- Customer identifiers for cross-channel linking
...
-- Conversations: threaded exchanges within a channel session
...
-- Messages: individual communications (incoming/outgoing)
...
-- Tickets: support inquiries with lifecycle tracking
...
-- Agent metrics: daily aggregated metrics
